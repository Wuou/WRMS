...
- (void)viewDidLoad {
    ...
    UIButton *btnEsc = [[UIButton alloc]initWithFrame:CGRectMake(0, 15, 75, 75)];
    [btnEsc setImage:[UIImage imageNamed:@"closeVedio"] forState:UIControlStateNormal];
    [btnEsc addTarget:self action:@selector(buttonclose) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:btnEsc];
