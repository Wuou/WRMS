...
//  LeftSlide
//
//  Created by YangJingchao on 2016/8/1.
...
@interface YNVedioRecordVC () <WCLRecordEngineDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@implementation YNVedioRecordVC
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    self.recordEngine.maxRecordTime = 10.0;
}
...
- (IBAction)recordNextAction:(id)sender {
    if (_recordEngine.videoPath.length > 0) {
        ...
        [self.recordEngine stopCaptureHandler:^(UIImage *movieImage) {
            ...
            [dictonary setValue:weakSelf.recordEngine.videoPath forKey:@"vedioUrl"];
            [[NSNotificationCenter defaultCenter]
             postNotificationName:@"RecordVedio" object:nil userInfo:dictonary];
