...
@implementation YNRequestWithArgs
...
//    defaultWebServiceUrl = defaultWebServiceUrl;
...
+ (YNRequestWithArgs *)serviceMethodName:(NSString*)name soapMessage:(NSString*)msg{
    YNRequestWithArgs *args=[[[YNRequestWithArgs alloc] init] autorelease];
